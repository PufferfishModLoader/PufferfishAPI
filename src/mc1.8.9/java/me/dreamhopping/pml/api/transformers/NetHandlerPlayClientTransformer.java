    ...
    public ClassNode transformClass(ClassNode classNode) {
        for (MethodNode methodNode : classNode.methods) {
            if (methodNode.name.equals("handleJoinGame")) {
                ...
                list.add(new MethodInsnNode(Opcodes.INVOKESTATIC, TransformerUtils.getImplementationClass("NetHandlerPlayClient"), "handleDisconnect", "(Lnet/minecraft/util/IChatComponent;)V"));
