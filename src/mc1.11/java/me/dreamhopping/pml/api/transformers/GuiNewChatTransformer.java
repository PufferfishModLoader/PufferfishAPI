    ...
    public ClassNode transformClass(ClassNode classNode) {
        for (MethodNode methodNode : classNode.methods) {
            if (methodNode.name.equals("printChatMessage")) {
                ...
                list.add(new MethodInsnNode(Opcodes.INVOKESTATIC, TransformerUtils.getImplementationClass("GuiNewChat"), "printChatMessage", "(Lnet/minecraft/util/text/ITextComponent;)V"));
