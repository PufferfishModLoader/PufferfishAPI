...
public final class EventSubscriber {
    ...
    public EventSubscriber(@NotNull Object instance, @NotNull Method method, @NotNull EventPriority priority) {
    ...
    @NotNull
    public final EventSubscriber copy(@NotNull Object instance, @NotNull Method method, @NotNull EventPriority priority) {
